...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl  fixed-start   bg-white" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'barang' ? ' active-page' : '' }}" href="{{ route('barang') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'pesanan' ? ' active-page' : '' }}" href="{{ route('pesanan') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <!-- Mengganti ikon ke "list_alt" -->
                    </div>
                    <span class="nav-link-text ms-1">Pesanan</span> <!-- Mengganti teks menjadi "Note List" -->
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'admin-profile' ? ' active-page' : '' }}  " href="{{ route('admin-profile') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <ul class="navbar-nav mt-5">
            <li class="nav-item mt-5">
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button type="submit" class="nav-link text-white mb-0 mt-5" style="background: none; border: none;">
